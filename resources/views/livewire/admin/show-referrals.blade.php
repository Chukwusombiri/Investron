    ...
    <div class="my-10 w-full px-4 flex items-center">
        <div class="w-full relative border h-12 shadow p-4 rounded-full flex items-center">
            <input type="text" wire:model.live="search"
                ...
                placeholder="Filter by upline, downline, or bonus">
                        ...
                        @foreach ($referrals as $referral)
                            <tr>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                     <p class="font-semibold mb-0 text-xs leading-tight text-slate-700">
                                        {{ $referral->username }} <a href="{{ route('admin.user.show', [$referral->user_id]) }}" class="ml-3 futura-light text-sm underline">click to view</a>
                                    </p>
                                </td>                                
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 text-xs font-semibold leading-tight">
                                        {{ $referral->downlineUsername }} <a href="{{ route('admin.user.show', [$referral->downline_id]) }}" class="ml-3 futura-light text-sm underline">click to view</a>
                                    </p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                ...
                                <td
                                    ...
                                    <span
                                        class="text-xs font-semibold leading-tight text-slate-400">{{ date('M d, Y', strtotime($referral->created_at)) }}</span>
                                </td>
                                        ...
                                        <x-slot name="content">
                                            ...
                                            <div class="block px-4 py-2 text-xs text-gray-400">
                                                ...
                                                <button
                                                    ...
                                                    wire:click='$emit("openModal","admin.reward-referrer",@json([$referral->id]))'>
                                                    <span class="mr-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button
                                                    class="flex item-center w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
                                                    wire:click="removeReferral('{{ $referral->id }}')">
                                                    <span class="mr-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
