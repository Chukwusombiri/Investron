            ...
            <div>
                <div class="w-full max-w-full px-3 shrink-0 mt-6">
                    <div class="mb-4">
                        <label for="username"
                            ...
                            <input type="text" wire:model.live="username" id="username" placeholder="Enter full name"
                ...
                <div class="w-full max-w-full px-3 shrink-0">
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.live="email" placeholder="Enter email address"
                            class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                ...
                <div class="w-full max-w-full px-3 shrink-0">
                    <div class="mb-4">
                        ...
                        <input type="password" wire:model.live="password" placeholder="Enter password"
                            class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                ...
                <div class="w-full max-w-full px-3 shrink-0">
                    <div class="mb-4">
                        ...
                        <input type="password" wire:model.live="password_confirmation" placeholder="Repeat new password"
                            class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                ...
                <div class="w-full max-w-full px-3 shrink-0">
                    <div class="mb-4">
                        <label for="admin_role"
                            ...
                            Role</label>
                        <select wire:model.live="admin_role" id="admin_role"
                            class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
