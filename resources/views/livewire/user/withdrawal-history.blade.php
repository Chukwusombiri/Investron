    ...
    <div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div
                ...
                <h6 class="text-xl futura-medium mb-6 md:mb-0">Withdrawal History</h6>
                <x-link-two href="{{route('user.withdrawal.create')}}" class="rounded-xl tracking-wide">Withdraw</x-link-two>
            </div>
                                ...
                                @foreach ($withdrawals as $withdrawal)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <span
                                                class="text-sm font-semibold leading-tight text-neutral-900">{{ date('M d, Y | H:i', strtotime($withdrawal->created_at)) }}</span>
                                        </td>

                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
                                                class="font-serif text-sm font-semibold leading-tight">
