<div
    class="w-full lg:w-7/12 mx-auto flex flex-col min-w-0 mt-6 px-4 py-6 break-words bg-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border">
    <x-alert />
    ...
    <div class="mt-4">
        ...
        <x-input id="name" class="block mt-1 w-full px-4 py-2 md:py-4" type="text" wire:model.live="name" required
    ...
    <div class="mt-4">
        ...
        <x-input id="address" class="block mt-1 w-full px-4 py-2 md:py-4" type="text" wire:model.live="address" required
