    ...
    <div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div
                ...
                <h6 class="text-xl futura-medium mb-6 md:mb-0">Transaction history</h6>
                <div class="flex items-center">                    
                    <x-link-two href="{{route('user.deposit.pricingTable')}}" class="rounded-xl tracking-wide mr-0 mb-3 md:mb-0 md:mr-3">Deposit</x-link-two>
                    <x-link-one href="{{route('user.withdrawal.create')}}" class="py-2 rounded-xl tracking-wide">Withdraw</x-link-one>
                </div>
            </div>
                                ...
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <p
                                                class="mb-0 text-sm font-semibold leading-tight">
                                                {{ $transaction->wallet}}</p>
                                        </td>                                        
                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
                                                class="text-sm futura-light leading-tight text-neutral-900">{{ date('M d, Y', strtotime($transaction->transaction_date)) }}</span>
                                        </td>
                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
