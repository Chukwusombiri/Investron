...
function SelectListLight({ field, onChange, title, errors = null, options, classProps='' }) {
    ...
    return (
        <div className={`${classProps} relative`} ref={selectRef}>
            <button
                ...
                className={`peer bg-transparent h-10 w-full inline-flex justify-between items-center text-sm ${selectedOption==title ?  'text-gray-600' : 'text-primary-500'} px-2 outline-none border-0 ring-0 border-b border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-500`}
            >
...
export default SelectListLight